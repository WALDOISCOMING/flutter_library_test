...
class SecureStorageItemsWidget extends StatefulWidget {
  const SecureStorageItemsWidget({Key? key}) : super(key: key);

  @override
  _SecureStorageItemsWidget createState() => _SecureStorageItemsWidget();
}

enum _Actions { deleteAll }
enum _ItemActions { delete, edit, containsKey }

class _SecureStorageItemsWidget extends State<SecureStorageItemsWidget> {
